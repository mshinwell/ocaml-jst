...
struct caml_thread_struct {
  ...
  /* XXX mshinwell: check if we need to alter the disabling-stack-checks
     patch for the presence of [signal_stack] */
...
static void * caml_thread_start(void * v)
{
  ...
  s = atomic_load(&Locking_scheme(dom_id));
  // XXX mshinwell: rename [thread_stop] -> [thread_detach_from_runtime]?
